namespace UnofficialTLDPatch
{
    public static class BuildInfo
    {
        ...
        */
        ...
        public const string Name                            = "UnofficialTLDPatch";
        /// <summary>Who made the mod</summary>
        public const string Author                          = "UnofficialTLDPatch Team";
        /// <summary>Current version (Using Major.Minor.Build) </summary>
        public const string Version                         = "1.0.0";
        /// <summary>Name used on GUI's, like ModSettings</summary>
        public const string GUIName                         = "Unofficial The Long Dark Patch";
        ...
        public const string Description                     = "Provides fixes and adjustments not yet implemented into the game by the Devs";
        /// <summary>Company that made it</summary>
        public const string Company                         = "UnofficialTLDPatch Team";
        ...
        public const string Product                         = "UnofficialTLDPatch";
